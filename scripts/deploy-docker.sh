...
sudo docker-compose -f /home/ubuntu/cicd/docker-compose-qr.yml down
...
sudo docker-compose -f /home/ubuntu/cicd/docker-compose-qr.yml build
...
sudo docker-compose -f /home/ubuntu/cicd/docker-compose-qr.yml up -d
